...
function applyTextLayout(){
 ...
 const brightness=+$('photoBrightness').value/100;
 const overlay=+$('overlayStrength').value/100;
 const vignette=+$('vignetteStrength').value/100;
 poster.style.setProperty('--photo-brightness',brightness);
 poster.style.setProperty('--overlay-opacity',overlay);
 poster.style.setProperty('--vignette-alpha',vignette);
 $('brightnessValue').textContent=$('photoBrightness').value;
 $('overlayValue').textContent=$('overlayStrength').value;
 $('vignetteValue').textContent=$('vignetteStrength').value;
